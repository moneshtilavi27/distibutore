...
$qry="SELECT DISTINCT `vendor`.`vender_name` AS `customer`,`vendor`.`vender_mob` AS `mob`, `vendor`.`vender_gst` AS `gst_no`,`vendor`.`vender_address` AS `address`,`purchase_return`.`purchase_date` AS `date` FROM `purchase_return`,`purchase_return_number`,`vendor` WHERE `vendor`.`vender_id`=`purchase_return`.`vender_id` AND `purchase_return_number`.`number`=`purchase_return`.`return_num` AND `purchase_return_number`.`number`='$invoice_num' LIMIT 1";
        ...
        <div class="col-md-10 ">
            <div class="row cust_add">
                <div class="col-md-3">
                    ...
                    <label>Bill No:-</label>
                    <input type="text" name="" value="<?php echo $invoice_num;?>" class="col-md-1 form-control input-sm"
                        id="customer_name" readonly="" style="background-color:white; font-size:14pt; ">
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-3">
                    <label>Date:-</label>
                    <input type="text" name="" value="<?php echo $out['date'];?>"
                        class="col-md-1 form-control input-sm " id="customer_email" readonly=""
                        style="background-color:white; font-size:14pt;">
                </div>
                <div class="col-md-3">
                    <label>Customer Mobile No:-</label>
                    <input type="text" name="" value="<?php echo $out['mob'];?>" class="col-md-1 form-control input-sm "
                        id="customer_mob" readonly="" style="background-color:white; font-size:14pt;">
                </div>
                <div class="col-md-3">
...
<div class="col-md-12 theam " style="margin-top: 5px;">
    <div class="tbl1" id="tb">
        <table class="fixed_header table table-bordered" id="table">
            ...
            $sn=0;
              $qry="SELECT `item`.`item_name` AS `item_name`,`item`.`item_hsn` AS `hsn`,`item`.`item_pc` AS `item_pc`,`purchase_return`.`gst_per` AS `item_gst`,`purchase_return`.`purchase_qty` AS `qty`,`purchase_return`.`purchase_mrp` AS `value` FROM `purchase_return`,`item` WHERE `purchase_return`.`item_id`=`item`.`item_id` AND `purchase_return`.`return_num`='$invoice_num';";
              $confirm=mysqli_query($conn,$qry)or die(mysqli_error());
        ...
        <div class="row">
            ...
            <div class="col-md-2" style="margin-top: -10px; margin-left: 0px; display:none;">
                <label for="input"></label>
                <input type="text" value="<?php echo $invoice_num;?>" id="bill" style="display: none;">
                <input type="button" name="Print" value="Print" class="col-md-6 input-sm btn-success" id="print">
            </div>
